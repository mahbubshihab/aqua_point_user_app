...
class MainShellPage extends StatelessWidget {
  ...
  void _showContactModal(BuildContext context) {
    showDialog(
      ...
      builder: (dialogContext) => const _ContactSupportDialog(),
    );
  }
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Subtitle
                Text(
                  'ওয়াটার পিউরিফায়ার সংক্রান্ত যেকোনো প্রয়োজনে\nকল অথবা হোয়াটসঅ্যাপ করুন।',
                  textAlign: TextAlign.center,
                  style: GoogleFonts.hindSiliguri(
                    fontSize: 14,
                    height: 1.45,
                ...
                // Dynamic Firestore Query for Phone & WhatsApp
                StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                  ...
                  builder: (context, snapshot) {
                    String phone = '01780-885841';
                    String whatsapp = '01780-885841';

                    if (snapshot.hasData &&
                        snapshot.data!.exists &&
                        snapshot.data!.data() != null) {
                      final data = snapshot.data!.data()!;
                      final p = (data['phone1'] as String?)?.trim() ??
                          (data['phone'] as String?)?.trim();
                      final w = (data['whatsappNumber'] as String?)?.trim() ??
                          (data['whatsapp'] as String?)?.trim();
                      if (p != null && p.isNotEmpty) phone = p;
                      if (w != null && w.isNotEmpty) whatsapp = w;
                    }

                    return Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        // Button 1: সরাসরি কল করুন
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xFF0084B4),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xFF1EB86B),
                              foregroundColor: Colors.white,
                              elevation: 0,
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(14),
